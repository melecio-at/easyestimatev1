    ...
    pages: {
      ...
      quotation_list: {
        ...
        sub_header_section: {
          ...
          b: {
            ...
            steps: {
              1: 'Step1　「見積を作成」ボタンをクリック',
              2: 'Step2　 必須フィールドに情報を入力',
              3: 'Step3　「見積もりプレビュー」ボタンをクリック',
              4: 'Step4　見積結果の送信',
            },
          },
          last_paragraph: {
      ...
      quotation_create: {
        ...
        label: {
          ...
          devices_and_browsers_placeholder: 'デバイス／ブラウザ名',
          specify_at_least_one: ' 最低１つ指定してください。',
          ...
          spec_doc_provided: '仕様書を貴社でご用意いただく',
