...
return [
    'activation_token_not_found' => 'Invalid/Expired Activation Token.',
    'auth_model_not_set' => 'Auth Model not set.',
    'invalid_password_reset_token' => 'Invalid/Expired Password Reset Token.',
